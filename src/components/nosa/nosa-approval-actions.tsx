...
export function NosaApprovalActions({ nosaId, status, user }: NosaApprovalActionsProps) {
        ...
        {["department_head", "hr_admin", "super_admin"].includes(user.role) && (
          <>
            ...
            <Dialog open={rejectOpen} onOpenChange={setRejectOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>Reject NOSA</DialogTitle>
                  <DialogDescription>
                    Provide a reason for rejecting this Notice of Salary Adjustment.
                  </DialogDescription>
                </DialogHeader>
                ...
                <DialogFooter>
                  ...
                  <Button
                    ...
                    onClick={() =>
                      handle(async () => {
                        const r = await reviewNosa(nosaId, false, rejectReason);
                        setRejectOpen(false);
                        return r;
                      })
                    }
